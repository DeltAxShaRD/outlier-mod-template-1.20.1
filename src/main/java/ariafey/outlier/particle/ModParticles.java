...
public class ModParticles {
    ...
    private static DefaultParticleType registerParticle(String name, DefaultParticleType particleType) {
        return Registry.register(Registries.PARTICLE_TYPE, new Identifier(OutlierMod.MOD_ID, name), particleType);
    }

    public static void registerParticles() {
        OutlierMod.LOGGER.info("Registering Particles for " + OutlierMod.MOD_ID);
    }
}
