...
import ariafey.outlier.block.entity.GemEmpoweringStationBlockEntity;
...
public class GemEmpoweringScreenHandler extends ScreenHandler {
    ...
    public GemEmpoweringScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity,
