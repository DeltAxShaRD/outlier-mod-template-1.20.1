...
public class ModPaintingVariantTagProvider extends TagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup lookup) {
        getOrCreateTagBuilder(PaintingVariantTags.PLACEABLE)
                .addOptional(new Identifier(OutlierMod.MOD_ID, "saw_them"))
                .addOptional(new Identifier(OutlierMod.MOD_ID, "shrimp"))
                .addOptional(new Identifier(OutlierMod.MOD_ID, "world"));
    }
}
